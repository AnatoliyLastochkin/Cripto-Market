...
/* harmony import */ var _Filter_Filter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7);
/* harmony import */ var _Table_Table_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(15);
/* harmony import */ var _Portfolio_Portfolio_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16);
/* harmony import */ var _TradeWidget_TradeWidget_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(17);
/* harmony import */ var _Services_DataServuce_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(18);
/* harmony import */ var _App_css__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(20);
...
function () {
  function App(_ref) {
    ...
    _Services_DataServuce_js__WEBPACK_IMPORTED_MODULE_8__["dataService"].getCurrencies().then(function (data) {
      _this._data = data;
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(App, [{
    ...
    value: function _initTable() {
      ...
      this._table = new _Table_Table_js__WEBPACK_IMPORTED_MODULE_5__["default"]({
        element: this._el.querySelector('[data-element="table"]'),
        data: this._data
      });

      this._table.on('rowClick', function (evt) {
        return _this2._tradeItem(evt.detail);
      });
    }
  }, {
    key: "_initFilter",
    value: function _initFilter() {
      ...
      this._filter = new _Filter_Filter_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
      ...
      function () {
        ...
        _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(evt) {
          var filterValue, filterdData;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  filterValue = evt.detail;
                  _context.next = 3;
                  return _Services_DataServuce_js__WEBPACK_IMPORTED_MODULE_8__["dataService"].getCurrencies({
                    filter: filterValue
                  });

                case 3:
                  filterdData = _context.sent;

                  _this3._table.update(filterdData);
    ...
    value: function _initPortfolio() {
      this._portfolio = new _Portfolio_Portfolio_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
    ...
    value: function _initTradeWidget() {
      ...
      this._tradeWidget = new _TradeWidget_TradeWidget_js__WEBPACK_IMPORTED_MODULE_7__["default"]({
        element: this._el.querySelector('[data-element="portfolio"]')
      });

      this._tradeWidget.on('buy', function (evt) {
        var _evt$detail = evt.detail,
            item = _evt$detail.item,
            amount = _evt$detail.amount;
...
function (_Component) {
  ...
  function Filter(_ref) {
    ...
    _this.on('input', debounce(function (evt) {
...
function (_Component) {
  ...
  function Table(_ref) {
    ...
    _this._el.addEventListener('click', function (evt) {
      return _this._onRowClick(evt);
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Table, [{
    key: "_onRowClick",
    value: function _onRowClick(evt) {
      var target = evt.target.closest('tbody tr');
      if (!target) return;
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Portfolio, [{
    ...
    value: function _render() {
      ...
      var elements = this._el.querySelectorAll('.collapsible');
...
function (_Component) {
  ...
  function TradeWidget(_ref) {
    ...
    _this._el.addEventListener('keydown', function (evt) {
    ...
    _this._el.addEventListener('input', function (evt) {
      var value = +evt.target.value;
...
var dataService = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              return _context.abrupt("return", dataService.getCurrenciesPrices(data));
  ...
  getCurrenciesPrices: function getCurrenciesPrices(data) {
    var coinUrls = data.map(function (coin) {
      return getSingleCoinUrl(coin.id);
    });
    return _HttpService_js__WEBPACK_IMPORTED_MODULE_4__["HTTPService"].sendMultipleRequests(coinUrls).then(function (coins) {
      var dataWithPrices = data.map(function (item, index) {
...
/*#__PURE__*/
function () {
  function Mypromise(behaivorFunction) {
